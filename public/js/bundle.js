...
var addSelectOption = function addSelectOption(item, list) {
...
var loadPokemonQuestion = function loadPokemonQuestion() {
...
var displaySprites = function displaySprites() {
  if (this.status !== 200) {
    loadPokemonQuestion();
  }
  var jsonData = this.responseText;
...
var createDisplay = function createDisplay(spriteUrl) {
